...
--$boundary--";
					mail($to, $subject, $message, $headers);
									...
									?>
								<form action="services.php" method="post" class="col s12">
									<div class="row">
	...
	<main>
		...
		<div class="row services">
			<div class="col l12 s12 bilets mov1">
				<div class="servicesText">
					<h5 class="yellow-text ">Авиабилеты</h5>
					<p class="white-text">Поможем найти лучшие авиабилеты среди миллионов предложений от авиакомпаний</p>
				</div>
			</div>
			<div class="col l12 s12 insurance mov1">
				<div class="servicesText">
					<h5 class="yellow-text ">Страхование</h5>
					<p class="white-text">Договор туристического страхования даст Вам возможность избежать непредвиденных расходов во 
						время путешествия
					</p>
				</div>
			</div>
			<div class="col l12 s12 visa mov1">
				<div class="servicesText">
					<h5 class="yellow-text">Визовая поддержка</h5>
					<p class="white-text">Предоставляем профессиональную консультацию и помощь в оформлении виз</p>
				</div>
			</div>
			<div class="col l12 s12 passport mov1">
				<div class="servicesText">
					<h5 class="yellow-text ">Загранпаспорта</h5>
					<p class="white-text">Консультация и помощь в оформлении биометрических загранпаспортов</p>
				</div>
			</div>
			<div class="col l12 s12 sellTour mov1">
				<div class="servicesText">
					<h5 class="yellow-text ">Продажа туров</h5>
					<p class="white-text">Экзотические острова, пляжные курорты или морские круизы, горнолыжные или оздоровительные курорты, свадебные туры, отдых на лучших СПА, экскурсионные туры по Европе – отдых на Ваш вкус!
						А мы постараемся исполнить Вашу мечту!
					</p>
				</div>
			</div>
		</div>
...
--$boundary--";
		...
		if ($filesize < 10000000) { // проверка на общий размер всех файлов. Многие почтовые сервисы не принимают вложения больше 10 МБ
			mail($to, $subject, $message, $headers);
									...
									?>
				<form action="services.php" method="post" class="col l12">
