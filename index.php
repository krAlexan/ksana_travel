...
--$boundary--";
	...
	<main>
		<div class="row first">
			...
			<div class="col l12 m12 s12 ksana">
			...
			<div class="slider">
				<div class="one">
					<div class="sliderText">
						<h3 class="center white-text hide-on-small-only">
				...
				<div class="two">
					<div class="sliderText">
						<h3 class="center white-text hide-on-small-only">
							Мальдивы – райский уголок Индийского океана.
							Нетронутая природа, спокойствие и самый романтичный отдых.
						</h3>
					</div>
				</div>
				<div class="three">
					<div class="sliderText">
						<h3 class="center white-text hide-on-small-only">
							Миру есть чем вас удивить!
							Позвольте Вашим мечтам сбыться с KSANA TRAVEL!
						</h3>
					</div>
				</div>
				<div class="four">
					<div class="sliderText">
						<h3 class="center white-text hide-on-small-only">
							Египет - солнце и лето круглый год!
						</h3>
					</div>
				</div>
				<div class="five">
				...
				<div class="seven">
					<div class="sliderText">
						<h3 class="center white-text hide-on-small-only">
							Таиланд ждет Вас!
							Тысячи храмов, белоснежные пляжи и непроходимые джунгли.
						</h3>
					</div>
				</div>
			</div>
...
--$boundary--";
		...
		if ($filesize < 10000000) { // проверка на общий размер всех файлов. Многие почтовые сервисы не принимают вложения больше 10 МБ
			mail($to, $subject, $message, $headers);
									...
									?>
				<form action="index.php" method="post" class="col l12">
